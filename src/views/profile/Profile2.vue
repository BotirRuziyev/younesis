          ...
          <router-link :to="{ name: 'EditProfile' }" class="link">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M14.2929 15.3344L17.3344 12.2929C17.5219 12.1054 17.7763 12 18.0415 12C18.3067 12 18.5611 12.1054 18.7486 12.2929L19.7071 13.2514C20.0976 13.6419 20.0976 14.2751 19.7071 14.6656L16.6656 17.7071C16.4781 17.8946 16.2237 18 15.9585 18H14.5C14.2239 18 14 17.7761 14 17.5V16.0415C14 15.7763 14.1054 15.522 14.2929 15.3344Z"
                stroke="#121111"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
...
import ProfileHead from "@/components/Profile/Education.vue";
export default {
  name: "Profile",
  components: {
    ProfileHead,
