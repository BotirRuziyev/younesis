<template>
  <div class="deit_lins_to_projects">
    <div class="main_container">
      ...
      <div class="deit_lins_to_projects">
        <div v-for="(item, i) in links" :key="i" class="item">
          <div class="head">
          ...
          <div class="inputs">
            <div class="form_control">
              <form-input v-model:value="links[i].link_name" label="Название" @update:value="inputVal" />
            </div>
            <div class="form_control">
              <form-input v-model:value="links[i].link" label="Ссылка" @update:value="inputVal" />
            </div>
          </div>
        </div>
      </div>
      <div v-if="!links.length" class="empty_text">
        Прикрепляй ссылки на свои проекты <br />
        и .......
      </div>
