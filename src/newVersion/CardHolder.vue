<template>
  <div class="card_holder">
    <head-new to="Tinder" page_title="Визитница"></head-new>

    <div class="main_container">
      <div class="holder_filter">
        <button
          @click="current_filter = 0"
          :class="{ active: current_filter == 0 }"
        >
          Все
        </button>
        <button
          v-for="i in [5, 4, 3]"
          :key="i"
          :class="{ active: current_filter == i }"
          @click="current_filter = i"
        >
          <svg
...
import Holder from "@/components/newVersionComponents/Holder";
