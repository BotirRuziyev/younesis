<template>
    <div class="partner_search">
            ...
            <div class="main_container">
                <router-link to="" @click="$router.go(-1)" class="link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <path d="M9 5L2 12" stroke="white" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M9 19L2 12" stroke="white" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
                </router-link>
                <div class="partner_search_top" :class="formControl ? 'partner_search_top_active' : ''">
                    <input v-model="search" type="text" id="partner_search" placeholder="Найти продюсера"
                    ...
                    <div class="cleaning_btn" v-if="search.length > 0" @click="search = ''">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M14.8299 9.16992L9.16992 14.8299" stroke="#4D4D4D" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M14.8299 14.8299L9.16992 9.16992" stroke="#4D4D4D" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
                    <button class="find_btn" @click="findFun">
                        Найти
                    </button>
                </div>
            </div>
        ...
        <div class="partner_search_in" v-if="partnerSearch">
            <div class="main_container">
                <div class="partner_found">
                    Найдено <span>14</span> человек
                </div>
                <div class="partner_search_in_top">
                    <div class="partner_sorting">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10 8L7 5L4 8" stroke="#A6A5A5" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M7 19V5" stroke="#A6A5A5" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M14 16L17 19L20 16" stroke="#A6A5A5" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M17 5V19" stroke="#A6A5A5" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    ...
                    <router-link to="Filter" class="filter_link">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M18 7H21" stroke="#A6A5A5" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M3 7H14" stroke="#A6A5A5" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M11 17H21" stroke="#A6A5A5" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M3 17H6.5" stroke="#A6A5A5" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path
                                ...
                                stroke="#A6A5A5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path
                ...
                <div class="partner_search_cards">
                    <div class="card_item" v-for="item in partner" :key="item.id">
                        ...
                        <div class="specialty">
                            <div class="specialty_item" v-for="specialty of item.specialty" :key="1">
                                {{ specialty }}
                            </div>
                        </div>
                        <div class="card_foot">
                                ...
                                <div class="location">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            stroke="#A6A5A5" stroke-linecap="round" stroke-linejoin="round" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <div class="right_block">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M5.15408 13.8884C4.81603 14.0649 4.40707 14.0338 4.09956 13.8083C3.79204 13.5828 3.63947 13.2021 3.70614 12.8267L4.2457 9.73404L1.97409 7.55714C1.69642 7.29234 1.59466 6.89207 1.71215 6.52681C1.82964 6.16156 2.14568 5.89568 2.52565 5.84242L5.67963 5.39157L7.10356 2.55105C7.27239 2.21039 7.61973 1.99487 7.99993 1.99487C8.38013 1.99487 8.72747 2.21039 8.8963 2.55105L10.3202 5.39157L13.4742 5.84242C13.8542 5.89568 14.1702 6.16156 14.2877 6.52681C14.4052 6.89207 14.3034 7.29234 14.0258 7.55714L11.7542 9.73404L12.2937 12.8273C12.3604 13.2028 12.2078 13.5835 11.9003 13.809C11.5928 14.0345 11.1838 14.0656 10.8458 13.8891L7.99993 12.4185L5.15408 13.8884Z"
                                        stroke="#D3D2D2" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                            </div>
                        </div>
        ...
        <div class="not_found" v-if="found">
            <div class="main_container">
                По запросу «йцукеннгг» ничего не найдено. Измените запрос и повторите попытку
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    mounted() {
        document.querySelector("html").onclick = (e) => {
            if (
                !e.target.closest("#partner_search") && !e.target.closest(".cleaning_btn")
            ) {
